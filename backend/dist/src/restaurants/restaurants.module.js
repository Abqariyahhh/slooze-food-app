...
const restaurants_resolver_1 = require("./restaurants/restaurants.resolver");
...
exports.RestaurantsModule = RestaurantsModule = __decorate([
    (0, common_1.Module)({
        providers: [restaurants_service_1.RestaurantsService, restaurants_resolver_1.RestaurantsResolver],
    })
], RestaurantsModule);
